...
async def update_rating_table() -> str:
    ...
    try:
        ...
        for lv in levelList[5:]:
            ...
            # sy.draw(700, 100, 65, lvtext, (124, 129, 255, 255), 'mm', 5, (255, 255, 255, 255))
            im.alpha_composite(Image.open(maimaidir / 'design.png'), (200, height - 113))
            sy.draw(700, height - 70, 22, f'Designed by Yuri-YuzuChaN & BlueDeer233. Generated by {maiconfig.botName} BOT', ScoreBaseImage.text_color, 'mm')
            y = 100
            for _lv in lvlist: 
                x = 160
                y += 20
                im.alpha_composite(Image.open(maimaidir / 'UI_CMN_Chara_Level_S_01.png').resize((80, 80)), (50, y + 80))
