...
async def rise_score_data(qqid: int, username: Optional[str], rating: str, score: str) -> Union[str, Image.Image]:
    """
    上分数据
    ...
    try:
        ...
        msg = text_to_image(result.strip())
...
async def player_plate_data(qqid: int, username: Optional[str], ver: str, plan: str, nickname: Optional[str] = '') -> Union[str, Image.Image]:
    """
    查看将牌
...
async def level_process_data(
    ...
    try:
        ...
        msg = im.resize((1400, int(im.size[1] * round(1400 / 2200, 2))))
    except UserNotFoundError as e:
        msg = str(e)
    except UserDisabledQueryError as e:
        msg = str(e)
