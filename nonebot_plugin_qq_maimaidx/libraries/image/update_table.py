...
from ...resources import FOTNEWRODIN, TBFONT, pic_dir, plate_dir, rating_dir
...
class UpdateTable:
    ...
    _wu_id_bg       = Image.open(pic_dir / "border_table_master.png")
    ...
    async def update_rating_table(self):
        ...
        for lv in self.level_list[:-1]:
            ...
            for ds, songs in lvlist.items():
                ...
                _ds = ds.split(".")[-1]
                fot.draw(70, start_y + 35, 40, f".{_ds}", self._font_color, "lm", 4, (255, 255, 255, 255))
    ...
    def _draw_plate(
        ...
        for ds, songs in level_dict.items():
            ...
            fot.draw(72, start_y + 40, 40, "." + ds, self._font_color, "lm", 4, (255, 255, 255, 255))
            ...
            for num, song in enumerate(songs):
                ...
                ts.draw(x + 56, y + 4, 16, song.song_id, anchor="mm")
            start_y += (max_row + 1) * GRID_STEP + 30
        return im
