...
from .base import *
from .tools import base64_to_bytesio, image_to_bytesio
...
def song_chart_info(
    ...
    # logo
    im.alpha_composite(Image.open(pic_dir / "logo.png").resize((249, 120)), (65, 25))
    ...
    # bpm
    fn.draw(460, 345, 24, song.bpm, default_color, "lm")
    # id
    fn.draw(405, 435, 22, f"ID {song.song_id}", default_color, "lm")
    # genre
    ...
    for num, v in enumerate(song.difficulties):
        ...
        mr.draw(310, 590 + spacing, 20, v.note_designer, default_color, "mm")
        # notes
