...
def song_play_data(
    ...
    *, 
    ...
    mr.draw(255, 622, 18, song_name, default_color, "mm")
    # id
    tb.draw(160, 720, 22, song.song_id, default_color, "mm")
    # bpm
    tb.draw(380, 720, 22, song.bpm, default_color, "mm")
    ...
    for num, info in enumerate(play_result):
        ...
        if isinstance(info, PlayedResult):
            ...
            mr.draw(800, 302 + y * num, 30, "未游玩", default_color, "mm")
