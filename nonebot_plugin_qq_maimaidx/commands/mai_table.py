    ...
    try:
        ...
        if _rating:
            ...
            if args in LEVEL_LIST[:6]:
                ...
                result = await draw_rating_table(ServiceName.DIVINGFISH, rating, user_id, plan=_p)
            else:
                result = "无法识别的表格"
        elif plate:
            ...
            result = await draw_plate_table(ServiceName.DIVINGFISH, version, plan, user_id, page)
        else:
            result = "无法识别的表格"
...
async def _(
    ...
    try:
        ...
        data = await draw_plate_progress(user_id, username, ver, plan)
...
async def _(
    ...
    try:
        ...
        result = await draw_level_score_list(
        ...
        await level_score_list.send(str(e))